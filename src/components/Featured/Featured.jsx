...
function Featured() {
  ...
  return (
    <>
      ...
      {/* featured cta */}
      <div className="featured-cta flex justify-center text-left items-center md1000:bg-none md1000:bg-[#ff0336] min620:mb-[12.5rem] ">
        <div className="container page-padding min620:">
