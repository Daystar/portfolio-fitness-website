...
function TestimonialBoxes() {
  return (
    <>
      {/* <TestimonialBox
        text=" “I've been a member of Fitness Anytime for the past 6 months and it has been an amazing experience. The trainers are knowledgeable and supportive, the
