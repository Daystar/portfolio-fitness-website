            ...
            <div className="grid grid-cols-2 grid-rows-2 gap-y-20 min620:grid-cols-1 min620:mx-auto">
              ...
              <div className="flex flex-col relative">
                ...
                <div className="text-[18px] font-medium text-black flex gap-5">
                  <a href="https://www.linkedin.com/in/sagar-koli/" target="_blank" rel="noreferrer" ><i className="fa-brands fa-linkedin-in px-[14px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#ff0336] ease-in duration-200 hover:text-white"></i>
                  </a>
                  <a href="https://github.com/Daystar" target="_blank" rel="noreferrer" ><i className="fa-brands fa-github px-[14px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#ff0336] ease-in duration-200 hover:text-white"></i>
                  </a>

                  <a href="https://www.twitch.tv/daystar_bob" target="_blank" rel="noreferrer" ><i className="fa-brands fa-twitch px-[14px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#ff0336] ease-in duration-200 hover:text-white"></i>
                  </a>
                  <a href="https://www.youtube.com/@daystar_bob" target="_blank" rel="noreferrer" ><i className="fa-brands fa-youtube px-[13px] py-[13px] bg-[#f4f4f4] rounded-full cursor-pointer hover:bg-[#ff0336] ease-in duration-200 hover:text-white"></i>
                  </a>
